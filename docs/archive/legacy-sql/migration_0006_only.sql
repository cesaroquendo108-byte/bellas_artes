-- HISTÓRICO: copia de trabajo previa a la migración canónica 202608080006.
-- No aplicar directamente. Conserva la ruta RunPod únicamente como evidencia
-- del esquema anterior; 202608080008 bloquea nuevas reservas fuera de vast/fake.
