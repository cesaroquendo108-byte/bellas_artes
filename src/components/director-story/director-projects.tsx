...
type Filter =
  "all" | Extract<CreativeProjectStatus, "draft" | "completed" | "archived">;
  ...
  return (
    <div className="min-h-screen bg-[#080809] px-4 py-8 text-white sm:px-7 lg:px-10">
      <header className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
            Proyectos de director
          </h1>
          <p className="mt-2 text-sm text-slate-500">
            Gestiona proyectos narrativos persistentes.
          </p>
        </div>
        <Button
        ...
        >
          <Plus /> Crear nuevo proyecto
        </Button>
      </header>
      <div className="mt-8 flex flex-col gap-4 border-y border-white/[0.07] py-4 lg:flex-row lg:items-center lg:justify-between">
      ...
      {visible.length ? (
        ...
        <div className="mt-6 flex min-h-[50vh] flex-col items-center justify-center rounded-2xl border border-dashed border-white/10 text-center">
          ...
          <p className="mt-2 max-w-sm text-xs leading-5 text-slate-600">
            Crea tu primer proyecto Director o modifica la búsqueda.
          </p>
          <Button
            render={<Link href="/story/create?kind=director" />}
            nativeButton={false}
