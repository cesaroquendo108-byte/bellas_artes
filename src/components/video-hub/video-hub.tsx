    ...
    <div className="min-h-screen bg-[#080809] px-4 py-8 text-white sm:px-7 lg:px-10">
      <section className="relative overflow-hidden rounded-3xl border border-violet-400/20 bg-[#111114] px-6 py-9 sm:px-10 sm:py-12">
        ...
        <div className="relative max-w-3xl">
          <Badge className="border border-violet-400/20 bg-violet-500/10 text-violet-200"><Sparkles className="size-3" /> Video Suite</Badge>
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <Button render={<Link href="/media" />} nativeButton={false} variant="outline" size="lg" className="border-white/10 bg-white/[0.04] text-slate-200">Abrir Media Hub</Button>
          </div>
        </div>
      ...
      <section className="mt-12">
        <div className="mb-5"><p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-violet-300">Create Video</p><h2 className="mt-2 text-xl font-semibold">Empieza con una idea o una referencia</h2></div>
      ...
      <section className="mt-12">
        <div className="mb-5"><p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-fuchsia-300">Edit Video</p><h2 className="mt-2 text-xl font-semibold">Refina cada capa de tu metraje</h2></div>
