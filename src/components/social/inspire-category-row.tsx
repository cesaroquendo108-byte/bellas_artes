  ...
  return (
    <section id={category} className="scroll-mt-36 py-9">
      ...
      {posts.length ? (
        ...
        <div className="flex min-h-44 flex-col items-center justify-center rounded-2xl border border-dashed border-white/10 text-center">
          <SearchX className="size-6 text-slate-700" />
