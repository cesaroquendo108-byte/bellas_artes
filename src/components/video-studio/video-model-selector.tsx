...
const models = [
  ...
  { value: "motion-sync-v2", label: "Motion Sync V2" },
  { value: "seedance-2", label: "Seedance 2" },
  { value: "video-upscaler-v2", label: "Video Upscaler V2" },
  { value: "lip-sync-v2.5", label: "Lip-Sync V2.5" },
  { value: "character-swap-v2", label: "Character Swap V2" },
  { value: "kling-extend-v1.5", label: "Kling Extend 1.5" },
