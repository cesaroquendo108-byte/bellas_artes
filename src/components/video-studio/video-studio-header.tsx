  ...
  return (
    <header className="border-b border-white/[0.07] bg-[#0b0b0d]/95 px-3 py-3 backdrop-blur-xl sm:px-5">
      <div className="flex min-w-0 items-center gap-3">
        ...
        <nav
          aria-label="Estudios principales"
          className="hidden items-center rounded-lg border border-white/[0.08] bg-white/[0.025] p-1 md:flex"
        >
        ...
        <Button
          ...
          className="bg-violet-600 text-white hover:bg-violet-500 lg:hidden"
        >
