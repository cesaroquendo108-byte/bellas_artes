...
export const metadata: Metadata = { title: "Inspiración · Bellas Artes", description: "Galería pública de creaciones aprobadas por la comunidad.", alternates: { canonical: "/inspire" } }
