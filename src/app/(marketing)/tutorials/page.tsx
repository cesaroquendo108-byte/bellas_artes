...
export const metadata: Metadata = { title: "Tutoriales · Bellas Artes", description: "Guías paso a paso para crear y editar con Bellas Artes.", alternates: { canonical: "/tutorials" } }
